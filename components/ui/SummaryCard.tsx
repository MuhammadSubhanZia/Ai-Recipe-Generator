  ...
  return (
    <Card className="mt-10 max-w-3xl mx-auto bg-white/80 backdrop-blur-sm border border-gray-300 shadow-xl">
      <CardContent className="p-6 space-y-4">
        ...
        <hr />
        <h2 className="text-xl font-bold text-gray-800 text-right">Your delicious Meal is Ready!</h2>
        <p className="text-right font-serif text-lg text-gray-800">{language}</p>
      </CardContent>
    </Card>
  );
}
